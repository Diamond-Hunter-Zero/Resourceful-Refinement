...
public class ModRecipeTypes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<BrewersTapRecipe>> BREWERS_TAP_TYPE =
            RECIPE_TYPES.register("brewers_tap", () -> {
                return RecipeType.simple(ResourceLocation.fromNamespaceAndPath(ResourcefulRefinementMain.MOD_ID, "brewers_tap"));
            });
    ...
    public static final IRecipeTypeInfo BREWERS_TAP_TYPE_INFO = new RefinementRecipeTypeInfo(
